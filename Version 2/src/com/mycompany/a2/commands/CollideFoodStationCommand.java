...
/**
 * Custom command class which invokes a collision of food station
 * 
 * @author Mickey Huang
 *
 */
public class CollideFoodStationCommand extends Command {
	/**
	 ...
	 */
	public CollideFoodStationCommand(GameWorld gw) {
