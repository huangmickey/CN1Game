...
/**
 * This concrete class represents the Ant object which the player controls. The
...
public class Ant extends Movable implements ISteerable {
	 ...
	 */
	private Ant(Point location, int speed, int size) {
		super(size);
		this.setHeading(0);
		this.setSpeed(speed);
	...
	/**
	 * This method returns the Ant object. If Ant object is not created already then create one and return
	 * 
	 * @return Ant object represents the player
	 */
	public static Ant getAnt() {
		if (antPlayer == null) {
			antPlayer = new Ant(new Point(100,100), 15, 10);
		}
		return antPlayer;
	}
	/**
	 * This method's purpose is to reset the Ant's state variables
	 */
